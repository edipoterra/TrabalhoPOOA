...
import vo.vo_Pontuacao;

/**
 *
 * @author edipoterra
 */
public class gui_GridChegada extends JDialog implements PropertyChangeListener{
    ...
    /**
     * contrutor de grid de chegada
     */
    public gui_GridChegada() throws ClassNotFoundException, SQLException{
        this.criaComps();
        this.montaComps();

        this.setTitle("Cadastro Grid de Chegada");
    ...
    /**
     * contrutor de grid de chegada com conexao
     * @param conn
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    gui_GridChegada(Connection conn) throws ClassNotFoundException, SQLException {
        this.criaComps();
        this.montaComps();
    ...
    /**
     * cria componentes para tela grafica
     */
    public void criaComps() throws ClassNotFoundException, SQLException{
        ...
        this.labelPontuacao = new JLabel("Pontuacao");

        //criando campos de texto
        dao.dao_GridChegada grid = new dao.dao_GridChegada(conn);
        try {
        ...
        this.textPontuacao = new JTextField();
        this.textPontuacao.setEditable(false);
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    try {
                        ...
                        Logger.getLogger(gui_GridChegada.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void montaComps(){
        ...
        this.textPontuacao.setBounds(120, 170, 150, 30);
        this.add(this.comboProva);
        this.add(this.comboPista);
        this.add(this.comboPiloto);
        this.add(this.textPosicao);
        this.add(this.textPontuacao);

        //monta botoes
        this.buttonInserir.setBounds(10, 200, 90, 30);
        this.buttonAlterar.setBounds(100, 200, 90, 30);
        this.buttonExcluir.setBounds(190, 200, 90, 30);
        this.buttonLimpar.setBounds(10, 230, 90, 30);
        this.buttonCancelar.setBounds(100, 230, 90, 30);
    ...
    public void insere() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException{
        ...
        vo_Pontuacao pont = new vo_Pontuacao();
        pont.pontuacao(posicao);
        Integer pontos = pont.getPontos();

        textPontuacao.setText(pontos.toString());

        vo.vo_Posicao pos = new vo.vo_Posicao();
        ...
        corrida.setPontuacao(pont);
        dao.dao_GridChegada chegada = new dao.dao_GridChegada(conn);
        chegada.insere(corrida);
        JOptionPane.showMessageDialog(new JOptionPane(), "Grid de Chegada inserido com sucesso","Aviso!",JOptionPane.INFORMATION_MESSAGE);
        limpa();
    }
    ...
    public void altera() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException{
        ...
        dao.dao_GridChegada chegada = new dao.dao_GridChegada(conn);
        chegada.altera(corrida);
        JOptionPane.showMessageDialog(new JOptionPane(), "Grid de Chegada alterado com sucesso","Aviso!",JOptionPane.INFORMATION_MESSAGE);
        limpa();
    }
    ...
    public void exclui() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException{
        ...
        vo_Corrida corrida = new vo_Corrida();
        corrida.setEtapa(pista);
        corrida.setCodPista(pista);
        corrida.setCodPiloto(piloto);
        corrida.setPosicao(pos);

        dao.dao_GridChegada chegada = new  dao.dao_GridChegada(conn);
        chegada.exclui(corrida);
    ...
    /**
     * limpa todos os campos da tela grafica, exceto combos
     */
    public void limpa(){
        textPosicao.setText("");
        textPontuacao.setText("");
    }
    ...
    /**
     * metodo que traa os campos de texto
     * @param evt
     */
