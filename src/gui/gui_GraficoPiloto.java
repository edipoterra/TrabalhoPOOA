 ...
 * @author edipoterra
 */
public class gui_GraficoPiloto extends JDialog{
    private Connection conn;

    /**
     * metodo contrutor do grafico dos pontos do piloto
     * @throws exception_RegistroJaExisteException
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    public gui_GraficoPiloto() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException {
        montaComps();

        this.setTitle("Grafico Piloto");
     ...
     * @throws SQLException
     */
    public gui_GraficoPiloto(Connection conn) throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException {
        this.conn = conn;
        montaComps();
    ...
    /**
     * monta componentes da tela de grafico
     * @throws exception_RegistroJaExisteException
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    public void montaComps() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException{
        ...
        CategoryDataset dataset = gui_GraficoPiloto.createDataset(chegada);
        JFreeChart chart = gui_GraficoPiloto.createBarChart(dataset);
    ...
    private static CategoryDataset createDataset(dao_GridChegada chegada) throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException {
        ...
        for (int i = 0; i < dados[0].length; i++){
            dataset.addValue(Integer.parseInt(dados[4][i]), dados[3][i], dados[1][i]);
        }
    ...
    /**
     * metodo responsavel pela criacao do grafico de barras
     * @param dataset
     * @return
     */
