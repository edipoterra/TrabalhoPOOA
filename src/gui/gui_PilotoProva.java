 ...
 * @author edipoterra
 */
public class gui_PilotoProva extends javax.swing.JDialog{
    ...
    /**
     * Metodo construtor de piloto prova
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    public gui_PilotoProva() throws ClassNotFoundException, SQLException{
        this.criaComps();
        this.montaComps();

        this.setTitle("Relacao Piloto X Prova");
    ...
    /**
     * metodo construtor de piloto prova com conexao passada por parametro
     * @param conn
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    public gui_PilotoProva(Connection conn) throws ClassNotFoundException, SQLException {
        this.criaComps();
        this.montaComps();
    ...
    /**
     * Cria componentes graficos para a classe
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    private void criaComps() throws ClassNotFoundException, SQLException {
        ...
        String[] colunas = new String []{"Codigo","Nome","Pontos"};
        String[][] dados = new String [][]{
        };
        tabela = new JTable();
        tabela.setModel(new DefaultTableModel(new Object [][] { }, new String [] {"Codigo", "Piloto", "Pontos"}));
    ...
    /**
     * monta os componentes graficos na tela corrente
     */
    ...
    /**
     * Seleciona os dados dos pilotos por prova disputada
     * @throws exception_RegistroJaExisteException
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    private void seleciona() throws exception_RegistroJaExisteException, ClassNotFoundException, SQLException {
        ...
        dados = chegada.selectProvaPiloto(corrida);
